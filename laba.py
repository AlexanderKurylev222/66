...
def greet_user():
    """
    Открывает диалоговое окно для ввода имени пользователя 
...
def show_arithmetic_operations():
    """
    Открывает новое окно, где можно выполнять базовые арифметические операции:
    ...
    def calculate_operations():
        """
        Выполняет арифметические операции над введенными числами и отображает результат.
        """
        try:
...
def generate_random_numbers():
    """
    Генерирует список из 10 случайных чисел от 1 до 100 и выводит их в диалоговом окне.
    """
...
def find_min_max():
    """
    Находит минимальное и максимальное значения в списке случайных чисел.
    Предварительно проверяет, был ли список сгенерирован.
    """
...
def create_and_save_files():
    """
    Генерирует три файла с уникальными случайными числами и сохраняет их на диск.
    """
    try:
        data = []
        for _ in range(3):
...
def open_files():
    """
    Открывает созданные файлы через стандартный текстовый редактор.
    """
    try:
